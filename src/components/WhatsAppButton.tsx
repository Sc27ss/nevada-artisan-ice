...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <div className="absolute right-full mr-4 px-3 py-2 bg-gray-800 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap animate-fade-in">
        ¡Chatea con nosotros!
