        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="slide-left">
              <h3 className="text-2xl font-bold font-poppins text-gradient-rainbow-slow mb-8">
              ...
              <div className="space-y-8">
                {contactInfo.map((item, index) => (
                  <div key={index} className="flex items-start space-x-4 animate-fade-in-up" style={{ animationDelay: `${index * 0.2}s` }}>
                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-nevada-blue-pastel to-nevada-coral flex items-center justify-center text-2xl shadow-lg animate-gentle-zoom">
                      {item.icon}
                    </div>
                    <div>
              ...
              <div className="mt-12">
                <button
                  ...
                  className="flex items-center space-x-3 bg-green-500 hover:bg-green-600 text-white px-6 py-4 rounded-full font-semibold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 btn-shimmer animate-gentle-pulse"
                >
                ...
                <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-nevada-blue-pastel/20 to-nevada-coral/20 hover:shadow-3xl transition-all duration-300">
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="text-center animate-float">
                      ...
                      <h4 className="text-xl font-bold text-nevada-blue-dark mb-2 text-gradient-rainbow-slow">
